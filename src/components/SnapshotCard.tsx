          ...
          <DialogContent>
            ...
            <div className="space-y-4 py-2">
              ...
              <div>
                ...
                <p>{snapshot.analogy}</p>
              </div>
              <div>
                <h4 className="font-semibold text-sm text-gray-500">Original Text</h4>
                <p className="text-sm text-gray-600">{snapshot.originalText}</p>
              </div>
              <div>
                <h4 className="font-semibold text-sm text-gray-500">Next Review</h4>
